...
The article was pointing out a lot of problems and critical points of software visualization and asks a lot of questions but gives little answeres. There are hardly any facts on how to improve software visualizations but that that just shows, that there definetly is not "the solution" for software visualization and there is no simple solution either. We currently only know ho to design for one context.

Furthermore a visualization cannot make an expert out of a novice. It is not possible to highlight everything and are just a tool that makes understanding software easier.
